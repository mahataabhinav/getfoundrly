...
import { X, ArrowRight, Copy, RefreshCw, Edit, Download, Sparkles, TrendingUp, BookOpen, Lightbulb, FileText, Rocket, Calendar, Zap } from 'lucide-react';
              ...
              <div className="grid lg:grid-cols-3 gap-6">
                <div className="lg:col-span-2 space-y-4">
                  <div className="flex items-center justify-between">
                    <h3 className="text-xl font-semibold text-[#1A1A1A]">Your LinkedIn Post</h3>
                  ...
                  <div className="flex gap-3">
                    <button className="flex-1 bg-[#1A1A1A] text-white py-3 px-6 rounded-xl font-medium hover:bg-gray-800 transition-all hover:shadow-lg flex items-center justify-center gap-2">
                      <Download className="w-5 h-5" />
                      Export
                    </button>
                    <button className="flex-1 bg-gray-100 text-[#1A1A1A] py-3 px-6 rounded-xl font-medium hover:bg-gray-200 transition-all flex items-center justify-center gap-2">
                ...
                <div className="space-y-4">
                  <div className="bg-gradient-to-br from-blue-50 to-slate-50 rounded-2xl p-6 border border-gray-100">
                    ...
                    <div className="space-y-2">
                      <button className="w-full text-left px-4 py-3 bg-white hover:bg-gray-50 rounded-xl text-sm text-gray-700 transition-all">
                        Create carousel version
                      </button>
                      <button className="w-full text-left px-4 py-3 bg-white hover:bg-gray-50 rounded-xl text-sm text-gray-700 transition-all">
                        Generate follow-up posts
                      </button>
                      <button className="w-full text-left px-4 py-3 bg-white hover:bg-gray-50 rounded-xl text-sm text-gray-700 transition-all">
                        View competitor angles
                      </button>
                    </div>
                  </div>

                  <div className="bg-white rounded-2xl p-6 border border-gray-100">
                    <h4 className="font-semibold text-[#1A1A1A] mb-3">Hashtags</h4>
                    <div className="flex flex-wrap gap-2">
                      {['#Leadership', '#BrandVisibility', '#Marketing', '#GrowthStrategy', '#ContentCreation'].map((tag) => (
                  ...
                  <div className="relative">
                    <Foundii size={60} animate={true} gesture="celebrate" />
                    <div className="absolute -top-16 right-0 bg-white/90 backdrop-blur-sm px-4 py-2 rounded-xl shadow-lg border border-gray-200 whitespace-nowrap">
                      <p className="text-xs text-gray-700">Want a carousel for this too?</p>
                    </div>
                  </div>
                </div>
              </div>
